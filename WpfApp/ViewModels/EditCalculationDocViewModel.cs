...
namespace WpfApp.ViewModels
{
    public class EditCalculationDocViewModel : CalculationDocViewModel
    {
        ...
        public void SaveCalculationDoc()
        {
            ...
            {
                case (int)CalculationDoc.CalculationTypeEn.TurnOver:
                    ...
                    if (_calculationDoc.Versicherungssumme > 100000m && _calculationDoc.InkludiereZusatzschutz)
                        _calculationDoc.Risk = (byte)CalculationDoc.RiskEn.Mittel;
                ...
                case (int)CalculationDoc.CalculationTypeEn.BudgetarySum:
                ...
                case (int)CalculationDoc.CalculationTypeEn.CountEmployees:
            ...
            if (_calculationDoc.Risk == (byte)CalculationDoc.RiskEn.Mittel)
            {
                _calculationDoc.Beitrag = (_calculationDoc.CalculationType is (byte)CalculationDoc.CalculationTypeEn.BudgetarySum or 
                    (byte)CalculationDoc.CalculationTypeEn.BudgetarySum) ? _calculationDoc.Beitrag *= 1.2m : _calculationDoc.Beitrag *= 1.3m;
            }
